...
const termsOfUse = [
  ...
  '',
  '第１０条（変更の届け出）',
  '本会員は、Eメールアドレス、住所、電話番号、その他当社の定めた手続きの過程で当社に届け出た内容に変更が生じた場合には、すみやかに変更内容を当社に届け出るものとします。',
  ...
  '',
  '第１４条（個人情報の保護）',
  '個人情報（「個人情報の保護に関する法律」（平成15年5月30日法律第57号）第2条第1項に定める「個人情報」をいいます。以下同じ）に関するお問い合わせは以下のとおりとします。',
  ...
  '',
  '第１８条　（全額返金保証制度について）',
  '当アカデミーでは、一定の条件を満たす方を対象に、入会金および3ヶ月分の月額費用（未就学児クラスを含む場合は追加料金も含む）について全額返金保証制度を設けております。',
  '本制度は、安心してサービスをご利用いただくためのものであり、以下のすべての条件を満たしている場合に限り、適用されます。',
  '1. 返金保証の対象条件',
  '以下の条件をすべて満たしていることが返金保証の対象となります。',
  '・授業中は必ずビデオ（顔出し）と本名表示を行っていること。',
  '・無断遅刻・無断欠席が一度もないこと。ただし、やむを得ない理由が事前に連絡された場合に限り、1回まで免除されます。事後報告は原則認められません。',
  '・毎週3回以上のクラスに継続的に出席していること。',
  '・授業の予約をすべて適切に行っていること（予約記録はシステム上に保存されます）。',
  '・3ヶ月間のうちに、保護者との個別面談を1回以上実施していること（Zoomを用いた記録あり）。',
  '2. 不満点の共有と改善対応',
  '・本保証制度を利用するには、2ヶ月目の保護者面談時に、授業に関する**具体的な不満点（例：講師の対応、授業内容、教材の質など）**を明確にお伝えいただく必要があります。',
  '・面談にて不満点が確認された場合、当校は可能な限りの改善措置を実施いたします。',
  '・その後、改善がなされたにもかかわらず、3ヶ月間の受講終了時点でご満足いただけない場合に限り、返金保証の申請が可能です。',
  '3. 返金申請の期限と方法',
  '・返金申請は、3ヶ月目終了後から7日以内に限り受け付けます。',
  '・申請は、メールでの手続きを通じて行ってください。',
  '・お支払いがクレジットカードによるものであった場合は、同様の方法にて返金を処理いたします。',
  '・申請受付後、内容の確認を行い、7営業日以内に返金処理を完了いたします。',
  '4. 返金対象の範囲',
  '・返金保証はフリーレッスンのみが対象であり、プライベートレッスン（個別対応型レッスン）は返金保証の対象外',
  '・本制度に基づく返金対象は、以下の通りです：',
  '- 初月の入会金（50USD）',
  '- 毎月の月額費用（50USD × 最大3ヶ月分）',
  '- 未就学児クラス該当者には追加料金（＋10USD/月）も含まれます。',
  '・ただし、返金額は実際にお支払いいただいた金額に基づきます。',
  '- キャンペーン・割引等が適用された場合は、適用後の実際の支払い金額を上限とします。',
  '・教材費・振込手数料・その他サービスにかかる費用は返金対象外とします。',
  '5. 免責事項',
  '・クラスが満席や講師都合等により変更・振替が生じた場合、その対象授業については本制度の返金対象から除外（免責）されます。',
  'サクセス・アカデミー 運営：MERCY EDUCATION 合同会社MERCY',
